...
INSERT INTO public.teams (team_id, team_name, gender, age_group, division, coach_name, team_city, team_state, club_name, primary_contact, team_details_file_path, is_active) VALUES (12, 'Team_12', 'M', 20, 'Blue', 'John', 'Tempe', 'AZ', 'John Club', 1234567890, '/uploaded_files/Team12.pdf', true);
INSERT INTO public.teams (team_id, team_name, gender, age_group, division, coach_name, team_city, team_state, club_name, primary_contact, team_details_file_path, is_active) VALUES (7, 'Team_13', 'M', 20, 'Blue', 'Roy', 'Tempe', 'AZ', 'Roy Club', 1234567890, '/uploaded_files/Team13.pdf', true);
INSERT INTO public.teams (team_id, team_name, gender, age_group, division, coach_name, team_city, team_state, club_name, primary_contact, team_details_file_path, is_active) VALUES (8, 'Team_14', 'M', 20, 'Blue', 'Bob', 'Tempe', 'AZ', 'Bob Club', 1234567890, '/uploaded_files/Team14.pdf', true);
